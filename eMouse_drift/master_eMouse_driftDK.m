...
fpath    = 'F:\test_new_sim\SC_noise\'; % where on disk do you want the simulation? ideally an SSD...
if ~exist(fpath, 'dir'); mkdir(fpath); end

%KS2 path -- also has the waveforms for the simulation
KS2path = 'C:\Users\admin_lokal\Documents\GitHub\Kilosort2\';

% add paths to the matlab path
addpath(genpath('C:\Users\admin_lokal\Documents\GitHub\Kilosort2\')); % path to kilosort2 folder
addpath(genpath('C:\Users\admin_lokal\Documents\GitHub\npy-matlab\'));
